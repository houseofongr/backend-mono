...
public class GetPublicFileController {

    private final DownloadPublicFileUseCase downloadPublicFileUseCase;
    ...
    public ResponseEntity<?> download(
        ...
        DownloadFileResult result = attachment != null && attachment?
                downloadPublicFileUseCase.publicDownload(fileId, true) :
                downloadPublicFileUseCase.publicDownload(fileId, false) ;
