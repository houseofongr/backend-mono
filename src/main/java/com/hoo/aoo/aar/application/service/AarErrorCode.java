...
public enum AarErrorCode implements ErrorCode {
    ...
    SNS_ACCOUNT_NOT_FOUND("AAR-AUTHN-4", NOT_FOUND, "SNS 계정을 찾을 수 없습니다."),

    NICK_NAME_CONFLICT("AAR-AUTHN-5", CONFLICT, "중복된 닉네임입니다."),
    ALREADY_REGISTERED_SNS_ACCOUNT("AAR-AUTHN-6", CONFLICT, "이미 등록된 SNS 계정입니다."),
