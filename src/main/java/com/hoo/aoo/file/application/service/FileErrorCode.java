...
public enum FileErrorCode implements ErrorCode {
    ...
    MAKE_FILES_PARENT_DIRECTORY_FAIL("FILE-COMMON-9", INTERNAL_SERVER_ERROR, "상위 디렉토리를 생성하는 데 실패했습니다."),
    ILLEGAL_FILE_TYPE_DIR("FILE-COMMON-10", INTERNAL_SERVER_ERROR, "잘못된 파일 타입 경로입니다."),
    ILLEGAL_FILE_AUTHORITY_DIR("FILE-COMMON-11", INTERNAL_SERVER_ERROR, "잘못된 파일 권한 경로입니다."),
