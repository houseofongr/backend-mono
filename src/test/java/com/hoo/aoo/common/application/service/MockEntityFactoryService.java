...
public class MockEntityFactoryService {
    ...
    public static Item loadRectangleItem() throws Exception {
        ...
        return Item.load(rectangleItem.getItemId().getId(), rectangleItem.getRoomId().getId(), rectangleItem.getItemDetail().getName(), rectangleItem.getShape(), List.of(getSoundSource()));
    }
