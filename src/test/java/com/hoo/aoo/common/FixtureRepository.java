...
public class FixtureRepository {
    ...
    public static HouseDetail getHouseDetail() {
        return new HouseDetail("cozy house", "leaf", "this is cozy house");
    }

    public static House getHouse(HouseDetail houseDetail) throws Exception {
        return getHouse(houseDetail, List.of(getRoom("거실"), getRoom("주방")));
    }
    ...
    public static House getHouse(HouseDetail houseDetail, List<Room> rooms) throws Exception {
        return entityFactoryService.createHouse(houseDetail, 5000f, 5000f, 1L, 1L, rooms);
    }
    ...
    public static Home getHome() throws Exception {
        return entityFactoryService.createHome(getHouse(), getUser());
    }
