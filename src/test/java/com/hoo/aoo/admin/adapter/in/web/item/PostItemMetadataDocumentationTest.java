        ...
        mockMvc.perform(get("/mock/admin/create-item-metadata")
                ...
                .andDo(document("admin-create-item-metadata",
                        responseFields(
                                ...
                                fieldWithPath("items[].circleData.radius").description("원형의 반지름입니다."),

                                fieldWithPath("items[].rectangleData.x").description("직사각형의 x좌표입니다."),
                                fieldWithPath("items[].rectangleData.y").description("직사각형의 y좌표입니다."),
                                fieldWithPath("items[].rectangleData.width").description("직사각형의 가로 너비입니다."),
                                fieldWithPath("items[].rectangleData.height").description("직사각형의 세로 높이입니다."),
                                fieldWithPath("items[].rectangleData.angle").description("직사각형의 회전 각도입니다."),

                                fieldWithPath("items[].ellipseData.x").description("타원형의 x좌표입니다."),
                                fieldWithPath("items[].ellipseData.y").description("타원형의 y좌표입니다."),
                                fieldWithPath("items[].ellipseData.width").description("타원형의 가로 너비입니다."),
                                fieldWithPath("items[].ellipseData.height").description("타원형의 세로 높이입니다."),
                                fieldWithPath("items[].ellipseData.angle").description("타원형의 회전 각도입니다.")
                        )));
    }
