...
public class DomainFixtureRepository {
    ...
    public static SnsAccount getRegisteredSnsAccount() throws InvalidPhoneNumberException {
        ...
        return new SnsAccount(snsAccount.getEmail(), snsAccount.getSnsAccountId(), snsAccount.getName(), new UserId("010-0000-0000"), snsAccount.getDateInfo());
    }
}
