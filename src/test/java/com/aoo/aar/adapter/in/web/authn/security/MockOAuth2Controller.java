...
import com.aoo.admin.domain.user.UserId;
import com.aoo.admin.domain.user.snsaccount.SnsAccount;
import com.aoo.admin.domain.user.snsaccount.SnsAccountId;
import com.aoo.admin.domain.user.snsaccount.SnsAccountInfo;
