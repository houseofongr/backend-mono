...
class GetPieceControllerTest extends AbstractControllerTest {
    ...
    void testGetSpecificPiece() throws Exception {
        ...
        mockMvc.perform(get("/admin/pieces/{pieceId}?page=1&size=10", 1)
                        .with(user("admin").roles("ADMIN")))
                .andExpect(status().is(200))
                .andDo(document("admin-piece-get",
                        pathParameters(
                                parameterWithName("pieceId").description("조회할 피스의 식별자입니다."),
                        ...
                        responseFields(
                                ...
                                fieldWithPath("sounds[].soundId").description("사운드의 식별자입니다."),
