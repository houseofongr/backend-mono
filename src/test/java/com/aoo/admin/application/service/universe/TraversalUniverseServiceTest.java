...
class TraversalUniverseServiceTest {
    ...
    Space space1 = Space.loadTreeComponent(1L, 4L, 1L, null, "space1", "유니버스의 스페이스-1", 0.5f, 0.5f, 0.7f, 0.6f, ZonedDateTime.now(), ZonedDateTime.now());
    Space space2 = Space.loadTreeComponent(2L, 5L, 1L, null, "space2", "유니버스의 스페이스-2", 0.4f, 0.2f, 0.5f, 0.1f, ZonedDateTime.now(), ZonedDateTime.now());
    Space space3 = Space.loadTreeComponent(3L, 6L, 1L, 1L, "space3", "스페이스1의 스페이스-1", 0.2f, 0.3f, 0.4f, 0.2f, ZonedDateTime.now(), ZonedDateTime.now());
    Space space4 = Space.loadTreeComponent(4L, 7L, 1L, 2L, "space4", "스페이스2의 스페이스-1", 0.7f, 0.4f, 0.3f, 0.3f, ZonedDateTime.now(), ZonedDateTime.now());
    Space space5 = Space.loadTreeComponent(5L, 8L, 1L, 2L, "space5", "스페이스2의 스페이스-2", 0.8f, 0.1f, 0.2f, 0.4f, ZonedDateTime.now(), ZonedDateTime.now());
    List<Space> spaces = List.of(space1, space2, space3, space4, space5);

    Piece piece1 = Piece.loadTreeComponent(1L, 9L, 1L, null, "element1", "유니버스의 엘리먼트-1", 0.5f, 0.5f, 0.7f, 0.6f, ZonedDateTime.now(), ZonedDateTime.now());
    Piece piece2 = Piece.loadTreeComponent(2L, 10L, 1L, 1L, "element2", "스페이스1의 엘리먼트-1", 0.4f, 0.2f, 0.5f, 0.1f, ZonedDateTime.now(), ZonedDateTime.now());
    Piece piece3 = Piece.loadTreeComponent(3L, 11L, 1L, 3L, "element3", "스페이스3의 엘리먼트-1", 0.2f, 0.3f, 0.4f, 0.2f, ZonedDateTime.now(), ZonedDateTime.now());
    Piece piece4 = Piece.loadTreeComponent(4L, 12L, 1L, 4L, "element4", "스페이스4의 엘리먼트-1", 0.7f, 0.4f, 0.3f, 0.3f, ZonedDateTime.now(), ZonedDateTime.now());
    Piece piece5 = Piece.loadTreeComponent(5L, 13L, 1L, 4L, "element5", "스페이스4의 엘리먼트-2", 0.8f, 0.1f, 0.2f, 0.4f, ZonedDateTime.now(), ZonedDateTime.now());
    Piece piece6 = Piece.loadTreeComponent(6L, 14L, 1L, 5L, "element6", "스페이스5의 엘리먼트-1", 0.8f, 0.1f, 0.2f, 0.4f, ZonedDateTime.now(), ZonedDateTime.now());
    Piece piece7 = Piece.loadTreeComponent(7L, 15L, 1L, 5L, "element7", "스페이스5의 엘리먼트-2", 0.8f, 0.1f, 0.2f, 0.4f, ZonedDateTime.now(), ZonedDateTime.now());
