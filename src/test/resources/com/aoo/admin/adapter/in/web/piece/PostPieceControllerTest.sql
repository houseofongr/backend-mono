...
insert into SPACE(SPACE.ID, SPACE.CREATED_TIME, SPACE.UPDATED_TIME, SPACE.DESCRIPTION, SPACE.INNER_IMAGE_FILE_ID,
                  SPACE.TITLE, SPACE.SX, SPACE.SY, SPACE.EX, SPACE.EY, SPACE.PARENT_SPACE_ID, SPACE.UNIVERSE_ID)
values (1, current_timestamp, current_timestamp, '스페이스는 공간입니다.', 1, '공간', 0.3, 0.2, 0.2, 0.3, null, 1);