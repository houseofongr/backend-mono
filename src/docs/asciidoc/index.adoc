...
operation::admin-house-update[snippets='http-request,path-parameters,request-parts']

"생성 API와 동일하게 메타데이터 양식을 지켜야 합니다."
-- 메타데이터에 관한 정보는 <<_metadata>>를 참고하시기 바랍니다.

operation::admin-house-update[snippets='http-response,response-fields']
