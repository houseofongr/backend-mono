...
operation::admin-house-get-room[snippets='path-parameters,http-request,http-response,response-fields']
...
operation::admin-house-delete-room[snippets='path-parameters,http-request,http-response,response-fields']
