...
[[admin-universe-post-update-api]]
==== 유니버스 수정 API

관리자가 유니버스를 수정합니다.

operation::admin-universe-post-update[snippets='http-request,request-parts,http-response,response-fields']

[[admin-universe-post-update-thumbnail-api]]
==== 유니버스 썸네일 수정 API

관리자가 유니버스의 썸네일을 수정합니다.

> 썸네일 파일 용량은 2MB를 초과할 수 없습니다.

operation::admin-universe-post-update-thumbnail[snippets='http-request,request-parts,http-response,response-fields']

[[admin-universe-delete-api]]
==== 유니버스 삭제 API

관리자가 유니버스를 삭제합니다.
> 유니버스 내부의 모든 연관된 정보(좋아요, 해시태그, 썸네일, 썸뮤직)을 함께 삭제합니다.
...
operation::admin-space-post-update[snippets='http-request,request-parts,http-response,response-fields']
