...
[[house-read-detail-api]]
==== 하우스 상세 조회 API

하우스와 내부 룸에 대한 상세 정보를 조회합니다.

operation::admin-house-read-detail[snippets='http-request,path-parameters,http-response,response-fields']
...
operation::admin-house-update[snippets='http-request,path-parameters,request-fields,http-response,response-fields']
...
operation::admin-house-room-load[snippets='http-request,path-parameters,http-response,response-fields']

[[house-room-update-api]]
==== 룸 정보 수정 API
...
operation::admin-house-room-update[snippets='http-request,path-parameters,request-fields']

> **originalName**을 찾을 수 없거나, **newName**이 기존 이름과 중복되면 오류가 발생합니다.

operation::admin-house-room-update[snippets='http-response,response-fields']

[[house-room-delete-api]]
==== 룸 삭제 API
...
operation::admin-house-room-delete[snippets='http-request,path-parameters,http-response,response-fields']
...
operation::admin-user-get-list[snippets='http-request,http-response,response-fields']

[[user-get-home-list-api]]
==== 사용자 홈 조회 API
